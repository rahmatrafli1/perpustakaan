        ...
        <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="get" action="">
                                ...
                                <div class="form-group">
                                    <label class="font-weight-bold" for="tanggal_sampai">Tanggal
                                        Pinjam Sampai</label>
            ...
            ?>
                <a class='btn btn-primary' target="_blank" href='<?php echo
                                                                    base_url() . 'petugas/peminjaman_cetak/?tanggal_mulai=' . $mulai . '&tanggal_sampai=' . $sampai ?>'><i class='fa fa-print'></i> CETAK</a>
            <?php
            }
            ?>
            <br />
