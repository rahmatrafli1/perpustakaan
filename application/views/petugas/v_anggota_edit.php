<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <a href="<?php echo base_url() . 'petugas/anggota' ?>" class='btn btn-sm btn-light
            ...
            <?php foreach ($anggota as $a) { ?>
                <form method="post" action="<?php echo base_url() . 'petugas/anggota_update';
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="nik" placeholder="Masukkan nik" required="required" value="<?php echo $a->nik; ?>">
                    </div>
                    <div class="form-group">
